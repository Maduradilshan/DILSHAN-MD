...
const store = makeInMemoryStore({   logger: pino().child({ level: "silent", stream: "store" }),  });
      ...
      //---------------------------------------------------------------------------
  sᴜʜᴀɪʟ_ᴍᴅ.smd({ pattern: "setcmd",desc: "To check ping",category: "general",filename: __filename, },async(DILSHAN, msg,text, { isCreator } ) => {
...
async(DILSHAN, citel) => {
    ...
    return await citel.send('*Pong Dilshan*\n *' + (final - inital) + ' ms* ' , { edit: key } , "", citel );
});
  ...
  text = '';
   ...
   //str += `╰━━━━━━━━━━━───⊷\nsᴜʜᴀɪʟ ᴛᴇᴄʜ ɪɴғᴏ \n www.youtube.com/c/DILSHANTechInfo`
  ...
  async(DILSHAN, msg, text ,{isCreator , cmd,cmdName }) => {
