...
smd({
        ...
        async(DILSHAN , msg, text) => {
         try{
            ...
            return await DILSHAN .bot.sendMessage(msg.chat, {image: { url: h },caption: `*_Scan Qr To Get You Text_*`,  } );
...
smd({
        ...
        async(DILSHAN, msg, text,{ isCreator}) => {
            ...
            try 
            {
                ...
                let pushnamer = DILSHAN.bot.getName(users);
