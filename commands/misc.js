...
smd({
        ...
        async(DILSHAN, msg, text) => {  let user = msg.sender.split('@')[0]  ; return await msg.reply( `https://wa.me/${user}` ); })
    //---------------------------------------------------------------------------
smd({
            pattern: "pick",
        ...
        async(DILSHAN, msg, match) => {
            if (!match) return msg.reply("*Which type of User you want?*");
            const groupMetadata = msg.isGroup ? await DILSHAN.bot.groupMetadata(msg.chat)
                .catch((e) => {}) : "";
...
//-----------------------------------------------------------------------------------
             // DILSHAN.bot.sendMessage(msg.chat, { react: { text: mokis,key: msg.key } })

    //---------------------------------------------------------------------------
smd({ on: "body" }, async(DILSHAN, msg,text,{icmd}) => {
